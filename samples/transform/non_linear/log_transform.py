...
# Load the image
imagePath=GU.UserInput("Enter image path (default: /datasets/BSDS300/images/train/26031.jpg): ",f"{ROOT}/datasets/BSDS300/images/train/26031.jpg")
colorImage,rgb,gray = image.load_image(imagePath)

# Apply Negative Transformation
logTransform = T.apply_transform(gray, "log")
...
plt.subplot(1, 3,3);plt.title("Log transform");plt.imshow(logTransform.astype(np.uint8), cmap='gray');plt.axis('off')
